export default {
    data: {
        host: 'http://ruiji.885505.com',  //api域名
        imgPath: 'http://ruiji.885505.com/uploads/', //图片地址前缀
        imgCodeUrl: '',  //图形验证码
    ...
    methods: {
        ...
        */
        ...
        // 普通跳转页面
        openWin(url, isLogin = false, addEvent = {}, send) {
        ...
        getImgCode() {
            let that = this;
            this.request({url:'/api/captcha'},{},function (ret) {
                that.imgCodeUrl = ret.data.img;
                that.captcha_key = ret.data.key;
            })
        },
        // 获取手机验证码
        getPhoneCode(captcha_code,phone,type,fn) {
            let that = this;
            this.request({url: '/api/base/sms',type: 'POST'},{
